                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input placeholder="Usuario" name="usuario" class="input--style-4" type="text" name="first_name">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Clave</label>
                                    <input placeholder="Clave" name="clave" class="input--style-4" type="password" name="last_name">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input name="fecha"  readonly><script>date = new Date().toLocaleDateString();document.write(date);</script>
