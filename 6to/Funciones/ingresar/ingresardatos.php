...
<style>
    body{
        background-image:url('https://www.publicdomainpictures.net/pictures/200000/velka/green-background-1480062887P1D.jpg');
    }
    img{
        max-width: 100%;
    }
...
<body>
<center><h1 class="subtitle" style="color: blanchedalmond;">Bienvenido <?php echo $nombre;?></h1></center>
<h2 class="text-center p-3">Registro de datos</h2>
    <div class="contenedor">
        <form class="col-4 p-3 m-auto" action="../graficar/graficos.php" class="formulario" id="formulario" name="formulario" method="POST">
