...
$campos = array("PAP", "CAR", "VID","PET","PEAD","ELEC","CTON","LAT","TAPA","RESP","RPBI"); // Agrega los nombres de los campos que deseas validar
...
$fecha= date('y/m/d');
$semestre=$sem;
$TOTALMATERIAL=($papel+$carton+$vidrio+$pet+$pead+$electronicos+$toner+$latas+$taparroscas+$residuos+$rpbi);
...
switch ($numero_aleatorio) {
  ...
  case 3:
   $mensaje="La concentración de CO2 en la atmósfera ha aumentado significativamente desde la Revolución Industrial";
    break;
  case 4:
    $mensaje="El CO2 es un gas inodoro, incoloro e insípido, lo que significa que no tiene sabor, color ni olor perceptible para los humanos";
    break;
  case 5:
...
<title>Materiales graficados</title>
<script type="text/javascript">
    ...
    <center><a href="/../6to/index.html"  class="btn">Volver</a></center>
</nav>
