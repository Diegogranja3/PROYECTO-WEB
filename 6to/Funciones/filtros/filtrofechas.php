...
<form class="form-inline"  method="POST"  name="formFechas" id="formFechas">
    <div class="col-xs-10 col-xs-offset-3">
        ...
        <a href="Basededatos.php"  class="btn btn-danger">Salir</a>
...
<td><?=$material->ID?></td>
            ...
            <td>
            <br>
    <a href="modificar2.0.1.php?id=<?=$material->ID?>"class="btn btn-small btn-warning"  ><i class="fa-solid fa-pen-to-square"></i></a>
        <br>
        <br>
        <a href="eliminar.php?id=<?=$material->ID?>" class="btn btn-small btn-danger" ><i   class="fa-solid fa-trash"></i></a>
        <br>
        <br>
      </td> 
		</tr>
