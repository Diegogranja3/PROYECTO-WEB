...
<table id="example" class="display" style="width:100%" text-align="center">
  ...
  <tbody>
   ...
   <td><?php echo $resultado["ID"]; ?></td>
      ...
      <td><?php echo $resultado["Residuos_biologicos"]; ?></td>
