...
<center><a href="filtrofechas.php" class="btn btn-primary">Filtro por fecha</a>
<a href="cerrarsesion.php" class="btn btn-danger">Cerrar sesion</a>
<a href="RegistroRapido.php" class="btn btn-success">Registro rapido</a>
<a href="graficasemestre" class="btn btn-primary">Graficar fechas grandes</a>
<center>
<br>
<script>
