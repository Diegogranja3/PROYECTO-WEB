...
<?php $busqueda=mysqli_query($conexion,"SELECT * FROM loginoperador WHERE Nombre_operador LIKE LOWER('%".$_POST["buscar"]."%')"); echo "<br>";
...
<table id="example1" class="display" style="width:100%" text-align="center">
  ...
  <tbody>
   ...
   <td><?php echo $resultado["ID_operador"]; ?></td>
      <td><?php echo $resultado["Nombre_operador"]; ?></td>
